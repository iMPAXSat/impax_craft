...
from impax_craft.util.exceptions import CRAFTWarning
...
class MyLogger(AstropyLogger):
    ...
    def _showwarning(self, *args, **kwargs):
        ...
        if not isinstance(args[0], CRAFTWarning):
        ...
        # be displayed.
        if type(warning) not in (CRAFTWarning,):
...
def _init_log(config=None):
    ...
    try:
        log = logging.getLogger("impax_craft")
